...
Welcome to Gomoku, a clean and modern implementation of the classic two-player strategy game, also known as Five-in-a-Row. This project is built as a fully-contained, single-file web application using HTML, CSS, and JavaScript, featuring a traditional and focused design.

**Live Demo:** [gomoku.fighterplay.com](https://gomoku.fighterplay.com)
...
There is no build process or server required. Simply open the `index.html` file in any modern web browser to start playing.
...
This project was created and is maintained by **HSINI MOHAMED**.
